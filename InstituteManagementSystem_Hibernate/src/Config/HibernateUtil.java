...
import Model.com.Batch;
import Model.com.Course;
import Model.com.Faculty;
import Model.com.Student;
	...
	public static SessionFactory getSessionFactory()
	{
		try {
			if(sf==null)
			{
				...
				map.put(Environment.JAKARTA_JDBC_URL, "jdbc:mysql://localhost:3306/coursem2o");
